...
INSERT INTO `absences` VALUES (1,'2019-07-11','2019-07-20',1,1,1),(2,'2019-07-30','2019-08-09',2,1,1),(3,'2019-07-31','2019-08-02',3,1,1);
...
INSERT INTO `absences_approvals` VALUES (1,'approved'),(2,'rejected'),(3,'waiting');
...
INSERT INTO `employee_role` VALUES (1,1),(2,1),(3,1),(4,1),(3,2),(4,2),(4,3);
...
INSERT INTO `employers` VALUES (1,'a@a.pl','Luca','{bcrypt}$2y$10$nResfs6gi4AcWiJqRdvKluY4Z3QMNPKXq1Wy3XpqVm.j4gv/jELRa','Tina','tina',1),(2,'user@user.pl','Anthony','{bcrypt}$2y$10$nResfs6gi4AcWiJqRdvKluY4Z3QMNPKXq1Wy3XpqVm.j4gv/jELRa','Worker','user',2),(3,'manager@manager.pl','David','{bcrypt}$2y$10$nResfs6gi4AcWiJqRdvKluY4Z3QMNPKXq1Wy3XpqVm.j4gv/jELRa','Manager','manager',3),(4,'director@director.pl','George','{bcrypt}$2y$10$nResfs6gi4AcWiJqRdvKluY4Z3QMNPKXq1Wy3XpqVm.j4gv/jELRa','Director','director',4);
...
INSERT INTO `employers_details` VALUES (1,20,'2019-12-27','2019-07-27',3000,20,1,1),(2,20,'2019-12-27','2019-07-27',3500,20,2,1),(3,20,'2019-12-27','2019-07-27',7000,20,2,2),(4,20,'2019-12-27','2019-07-27',15000,20,2,3);
...
INSERT INTO `payrolls` VALUES (1,2300,12,12,1,'07-2019'),(2,2300,12,12,1,'07-2019'),(3,2300,12,12,1,'07-2019');
...
CREATE TABLE `work_day` (
  ...
  UNIQUE KEY `work_day_workday_date_uindex` (`workday_date`),
...
--
-- Table structure for table `workday_employers`
--

DROP TABLE IF EXISTS `workday_employers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `workday_employers` (
  `workday_id` bigint(20) NOT NULL,
  `employee_id` bigint(20) NOT NULL,
  KEY `FK240hipfka3adr9wai4pe3jnkx` (`employee_id`),
  KEY `FKd5g8q1l6e1cwawqn9dt2sv9ly` (`workday_id`),
  CONSTRAINT `FK240hipfka3adr9wai4pe3jnkx` FOREIGN KEY (`employee_id`) REFERENCES `employers` (`id_employee`),
  CONSTRAINT `FKd5g8q1l6e1cwawqn9dt2sv9ly` FOREIGN KEY (`workday_id`) REFERENCES `work_day` (`id_workday`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `workday_employers`
--

LOCK TABLES `workday_employers` WRITE;
/*!40000 ALTER TABLE `workday_employers` DISABLE KEYS */;
/*!40000 ALTER TABLE `workday_employers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-04 14:54:13
